...
void   fml_layer_backprop(fml_layer* layer, fml_layer* next_layer);
double fml_layer_output_backprop(fml_layer* layer, fml_data* label, cost_function c);
void   fml_layer_input_backprop(fml_layer* layer, fml_layer* next_layer);
void   fml_layer_learn(fml_layer* layer);
